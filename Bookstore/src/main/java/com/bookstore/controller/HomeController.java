...
//		model.addAttribute("orderList", user.getOrderList());
	...
	public String addNewCreditCardPost(HttpServletRequest request,
...
//		model.addAttribute("orderList", user.getOrderList());
	...
	public String addNewShippingAddressPost(HttpServletRequest request,
...
//		model.addAttribute("orderList", user.getOrderList());
	...
	public String updateCreditCard(@ModelAttribute("id") Long creditCardId, Principal principal, Model model) {
		...
		if (user.getId() != userPayment.getUser().getId()) {
			...
			model.addAttribute("userPayment", userPayment);
			model.addAttribute(userBilling);
	...
	public String updateShippingAddress(@ModelAttribute("id") Long shippingAddressId, Principal principal,
			Model model) {
		User user = userService.findByUsername(principal.getName());
